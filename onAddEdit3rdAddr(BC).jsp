...
--%>
<%@ page import="oscar.src.main.webapp.billing.onAddEdit3rdAddrBean.java"%>
<jsp:useBean id="new3rdParty" scope="page" class="onAddEdit3rdAddrBean"/>
<% new3rdParty.init(request,out); %>
...
<%
      ...
      new3rdParty.setAuthed(true);
%>
<security:oscarSec roleName="<%=roleName$%>" objectName="_billing" rights="w" reverse="<%=true%>">
	<%new3rdParty.setAuthed(false); %>
	<%response.sendRedirect("../../../securityError.jsp?type=_billing");%>
</security:oscarSec>
<%
if(new3rdParty.getAuthed() == false) {
	return;
}
%>

<% new3rdParty.checkSessionForLogout(); %>
<% new3rdParty.handleRequestSubmit(); %>
